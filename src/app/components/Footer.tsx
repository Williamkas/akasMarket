    ...
    <footer className='bg-gray-50 border-t border-gray-200 mt-auto'>
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8'>
        <div className='grid grid-cols-1 md:grid-cols-4 gap-8'>
          ...
          <div className='col-span-1 md:col-span-2'>
            <div className='flex items-center mb-4'>
              ...
              <h3 className='text-lg font-semibold text-gray-900'>Akas Market</h3>
            </div>
            <p className='text-gray-600 mb-4 max-w-md'>
              Your trusted marketplace for quality products. Discover amazing deals and premium items for your home and
              lifestyle.
            </p>
        ...
        <div className='mt-8 pt-8 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center'>
          <p className='text-gray-500 text-sm'>&copy; {new Date().getFullYear()} Akas Market. All rights reserved.</p>
          <div className='mt-4 md:mt-0 flex items-center space-x-4'>
            ...
            <div className='flex space-x-2'>
              ...
              <div className='bg-gray-100 px-2 py-1 rounded text-xs font-medium text-gray-600'>MC</div>
